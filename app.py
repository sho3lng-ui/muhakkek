...
fact_to_check = st.text_area("أدخل المعلومة المراد فحصها بدقة، ويفضل تحديد المكان مثل البلد أو المحافظة وتحديد الزمان مثل السنة والشهر واليوم لتكون النتائج أفضل:", "السرطان يقوي عظام المريض")
